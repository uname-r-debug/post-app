            ...
            <form className="flex gap-4 rounded-xl mx-auto w-[80%]">
                ...
                <div className="bg-accent flex items-center rounded-xl grow">
                    <div className="grow grid gap-10 w-fit text-center">
                        <CardHeader className="gap-2"><CardTitle>Delete post?</CardTitle>
                            <CardDescription>Press the button below to delete the post.</CardDescription></CardHeader>
                        <Button onClick={handleClick} className="cursor-pointer mx-10">Submit</Button>
                    </div>
                </div>
            </form>
        </div>
